...
import (
	...
	V1Usecases "github.com/james-wukong/go-app/internal/business/usecases/v1"
	"github.com/james-wukong/go-app/internal/config"
	"github.com/james-wukong/go-app/internal/constants"
	"github.com/james-wukong/go-app/internal/http/datatransfers/requests"
	V1Handlers "github.com/james-wukong/go-app/internal/http/handlers/v1"
	"github.com/james-wukong/go-app/internal/mocks"
	...
	usersDataFromDB = []V1Domains.UserDomain{
		{
			...
			Password:       "23123sdf!",
			Active:         true,
			TimeBaseDomain: V1Domains.TimeBaseDomain{CreatedAt: time.Now()},
		},
		{
